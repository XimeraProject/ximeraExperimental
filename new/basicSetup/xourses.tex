...
part of a Xourse. This `magic' is achieved by `turning off'
...
Ximera document can only contain objects like
...
takeaway however is that best-practice is to create a preamble file
